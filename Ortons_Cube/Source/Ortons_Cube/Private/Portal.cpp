...
void APortal::BeginPlay()
{
	...
	if (FVector::Dist(GetActorLocation(), FVector(-9000.0f, 0.0f, -43690.0f)) < 500) {		// O->OP
		portalID = 15;
		fromRoomID = 16;
		toRoomID = 17;
	...
	if (FVector::Dist(GetActorLocation(), FVector(-36000.0f, 0.0f, -43690.0f)) < 500) {		// OP->O
		portalID = 15;
		fromRoomID = 17;
		toRoomID = 16;
	...
	if (FVector::Dist(GetActorLocation(), FVector(-9000.0f, 45000.0f, 1310.0f)) < 500) {		// R->PR
		portalID = 24;
		fromRoomID = 24;
		toRoomID = 23;
		to = FVector(-36300.0f, 45000.0f, 1310.0f);
	}
	if (FVector::Dist(GetActorLocation(), FVector(-36000.0f, 45000.0f, 1310.0f)) < 500) {		// PR->R
		portalID = 24;
		fromRoomID = 23;
		toRoomID = 24;
		to = FVector(-8700.0f, 45000.0f, 1310.0f);
	...
	if (FVector::Dist(GetActorLocation(), FVector(-9000.0f, -45000.0f, 46310.0f)) < 500) {		// BG->BGP 
		portalID = 30;
		fromRoomID = 2;
		toRoomID = 3;
		to = FVector(-36300.0f, -45000.0f, 46310.0f);
	}
	if (FVector::Dist(GetActorLocation(), FVector(-36000.0f, -45000.0f, 46310.0f)) < 500) {		// BGP->BG 
		portalID = 30;
		fromRoomID = 3;
		toRoomID = 2;
	...
	if (FVector::Dist(GetActorLocation(), FVector(9000.0f, -45000.0f, 46310.0f)) < 500) {		// BG->BGY
		portalID = 31;
		fromRoomID = 2;
		toRoomID = 4;
		to = FVector(36300.0f, -45000.0f, 46310.0f);
	}
	if (FVector::Dist(GetActorLocation(), FVector(36000.0f, -45000.0f, 46310.0f)) < 500) {		// BGY->BG
		portalID = 31;
		fromRoomID = 4;
		toRoomID = 2;
		to = FVector(8700.0f, -45000.0f, 46310.0f);
	...
	if (FVector::Dist(GetActorLocation(), FVector(36000.0f, 45000.0f, 46310.0f)) < 500) {		// BRY->BR
		portalID = 35;
		fromRoomID = 8;
		toRoomID = 7;
		to = FVector(8700.0f, 45000.0f, 46310.0f);
	...
	if (FVector::Dist(GetActorLocation(), FVector(45000.0f, -9000.0f, 46310.0f)) < 500) {		// BY->BGY
		portalID = 37;
		fromRoomID = 9;
		toRoomID = 4;
		to = FVector(45000.0f, -36300.0f, 46310.0f);
	}
	if (FVector::Dist(GetActorLocation(), FVector(45000.0f, -36000.0f, 46310.0f)) < 500) {		// BGY->BY
		portalID = 37;
		fromRoomID = 4;
		toRoomID = 9;
		to = FVector(45000.0f, -8700.0f, 46310.0f);
	...
	if (FVector::Dist(GetActorLocation(), FVector(9000.0f, -45000.0f, -43690.0f)) < 500) {		// GO->GOY
		portalID = 39;
		fromRoomID = 11;
		toRoomID = 13;
		to = FVector(36300.0f, -45000.0f, -43690.0f);
	}
	if (FVector::Dist(GetActorLocation(), FVector(36000.0f, -45000.0f, -43690.0f)) < 500) {		// GOY->GO
		portalID = 39;
		fromRoomID = 13;
		toRoomID = 11;
		to = FVector(8700.0f, -45000.0f, -43690.0f);
	...
	if (FVector::Dist(GetActorLocation(), FVector(-45000.0f, -9000.0f, -43690.0f)) < 500) {		// OP->GOP
		portalID = 44;
		fromRoomID = 17;
		toRoomID = 12;
	...
	if (FVector::Dist(GetActorLocation(), FVector(-45000.0f, -36000.0f, -43690.0f)) < 500) {		// GOP->OP
		portalID = 44;
		fromRoomID = 12;
		toRoomID = 17;
	...
	if (FVector::Dist(GetActorLocation(), FVector(-45000.0f, 9000.0f, -43690.0f)) < 500) {		// OP->OPR
		portalID = 45;
		fromRoomID = 17;
		toRoomID = 18;
		to = FVector(-45000.0f, 36300.0f, -43690.0f);
	...
	if (FVector::Dist(GetActorLocation(), FVector(-45000.0f, 36000.0f, -43690.0f)) < 500) {		// OPR->OP
		portalID = 45;
		fromRoomID = 18;
		toRoomID = 17;
		to = FVector(-45000.0f, 8700.0f, -43690.0f);
	...
	if (FVector::Dist(GetActorLocation(), FVector(-45000.0f, 45000.0f, 6380.0f)) < 500) {		// PR -> BPR
		portalID = 50;
		fromRoomID = 23;
		toRoomID = 6;
		to = FVector(-45000.0f, 44700.0f, 40920.0f);
	}
	if (FVector::Dist(GetActorLocation(), FVector(-45000.0f, 45000.0f, 40920.0f)) < 500) {		// BPR -> PR
		portalID = 50;
		fromRoomID = 6;
		toRoomID = 23;
		to = FVector(-45000.0f, 44700.0f, 6380.0f);
	...
	if (FVector::Dist(GetActorLocation(), FVector(-45000.0f, 45000.0f, -4040.0f)) < 500) {		// PR -> OPR
		portalID = 51;
		fromRoomID = 23;
		toRoomID = 18;
		to = FVector(-45000.0f, 44700.0f, -38640.0f);
	}
	if (FVector::Dist(GetActorLocation(), FVector(-45000.0f, 45000.0f, -38640.0f)) < 500) {		// OPR -> PR
		portalID = 51;
		fromRoomID = 18;
		toRoomID = 23;
		to = FVector(-45000.0f, 44700.0f, -4040.0f);
	...
	if (FVector::Dist(GetActorLocation(), FVector(45000.0f, 45000.0f, 6380.0f)) < 500) {		// RY -> BRY
		portalID = 52;
		fromRoomID = 25;
		toRoomID = 8;
	...
	if (FVector::Dist(GetActorLocation(), FVector(45000.0f, 45000.0f, 40920.0f)) < 500) {		// BRY -> RY
		...
		fromRoomID = 8;
		toRoomID = 25;
		to = FVector(45300.0f, 45000.0f, 6380.0f);
	}
